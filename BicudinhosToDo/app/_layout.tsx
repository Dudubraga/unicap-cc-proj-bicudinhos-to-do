...
export default function RootLayout() {
  ...
  if (appThemePreference === "system") {
    currentNavigationTheme =
      systemColorScheme === "dark" ? MyDarkTheme : MyDefaultTheme;
    statusBarThemeStyle =
      systemColorScheme === "dark" ? "light-content" : "dark-content";
  } else {
    currentNavigationTheme =
      appThemePreference === "dark" ? MyDarkTheme : MyDefaultTheme;
    statusBarThemeStyle =
      appThemePreference === "dark" ? "light-content" : "dark-content";
  }
